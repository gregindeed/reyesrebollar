...
export default function ManagerLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const { error } = await supabase.auth.signInWithOtp({
      email,
      options: { emailRedirectTo: "https://reyesrebollar.com/manager/dashboard" },
    });
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4">
      <div className="mb-10 text-center">
        <Image src="/reyesrebollar_logo.png" alt="RRP" width={48} height={48} className="object-contain mx-auto mb-4 opacity-85" />
        <p className="font-display text-xl text-foreground">Reyes Rebollar Properties</p>
        <p className="text-[0.62rem] tracking-[0.18em] uppercase text-terracotta mt-1">Manager Portal</p>
      </div>
        ...
        {!sent ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="reyes@reyesrebollar.com"
                  required
          ...
          <div className="text-center py-4">
            ...
            <button
              ...
              className="mt-6 text-[0.62rem] tracking-[0.14em] uppercase text-muted-foreground hover:text-foreground transition-colors border-b border-border/50 pb-0.5"
            >
